...
?>
  <form action="index.php?view_posts" method="post" enctype="multipart/form-data">
    <table width="795" align="center"  bgcolor="#CCCCCC">
      <tr bgcolor="#FF9933">
	     <td colspan="6" align="center"><h1>Update This Post:</h1></td>
	  </tr>
      <tr>
	     <td align="right" bgcolor="#FF9933"><strong>Post Title:</strong></td>
		 <td> <input type="text" name="post_title" size="60"  value="<?php echo $title; ?>"/></td>
	  </tr>
      <tr>
	     <td align="right" bgcolor="#FF9933"><strong>Post Category:</strong></td>
		 <td>
		  <select name="cat">
		     <?php 
      ...
      <tr>
	     <td align="right" bgcolor="#FF9933"><strong>Post Author:</strong></td>
		 <td> <input type="text" name="post_author" size="60" size="60"  value="<?php echo $author; ?>" /></td>
	  </tr>
	  <tr>
	     <td align="right" bgcolor="#FF9933"><strong>Post Keywords:</strong></td>
		 <td> <input type="text" name="post_keywords" size="60" size="60"  value="<?php echo $keywords; ?>" /></td>
	  </tr>
	  <tr>
	     <td align="right" bgcolor="#FF9933"><strong>Post Image:</strong></td>
		 <td> <input type="file" name="post_image" size="50" /> <img src="news_images/<?php echo $image; ?>" width="60" height="60" /></td>
	  </tr>
	  <tr>
	     <td align="right" bgcolor="#FF9933"><strong>Post Content:</strong></td>
